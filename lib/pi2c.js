...
//exec('sudo i2cdump -y -r 0x00-0x00 1 0x2A', 
...
//    }*/
//    var dato=[stdout[76]+stdout[77]];
//    var result=[];
//    result.push(parseInt('0x' + dato, 16));
//    //console.log('El dato es : ' + stdout[76]+stdout[77]);
//    console.log(result);
//    /*console.log('stdout[1]: ' + stdout[77]);
//    console.log('stdout[2]: ' + stdout[2]);
//    console.log('stdout[3]: ' + stdout[3]);
//    console.log('stdout[4]: ' + stdout[4]);
...
exports.dump = function(callback) {
    ...
    var cmd = 'sudo i2cdump -y -r 0x00-0x00 1 0x2A';
    //var cmd = 'sudo i2cget -y 1 0x2A 0x00 b';
    exec(cmd, function(err, stdout, stderr) {
        if (err) {
            callback(err);
        } else {
